...
var _immune_system_cell = __webpack_require__(7);
  ...
  _createClass(Game, [{
    ...
    value: function listenForFinalCancerCellsNeutralized() {
      ...
      createjs.Ticker.addEventListener('tick', function () {
        if (_this.cancerCells.every(function (cancerCell) {
    ...
    value: function addImmuneSystemCells() {
      ...
      this.cancerCells.forEach(function (cancerCell) {
        ...
        _this3.stage.addChild(immuneSystemCell.shape);
        _this3.immuneSystemCells.push(immuneSystemCell);
      });
    }
  }, {
    key: 'handleLevelWon',
